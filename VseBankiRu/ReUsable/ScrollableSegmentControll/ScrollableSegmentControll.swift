//
//  ScrollableSegmentControll.swift
//  VseBankiRu
//
...
//            flowLayout.itemSize = CGSize(width: 10, height: frame.size.height)
        } else {
            flowLayout.estimatedItemSize = UICollectionViewFlowLayout.automaticSize

//            width = 1.0
//            flowLayout.itemSize = CGSize(width: 10, height: frame.size.height)
//            flowLayout.estimatedItemSize = CGSize(width: 10, height: frame.size.height)
        }
    }
